...
def app():
    ...
    with tab4:
        ...
        mpi_guide_content = """Multidimensional Poverty Index (MPI) Methodology Guide
================================================================

1. INTRODUCTION
The Multidimensional Poverty Index (MPI) is an international measure of acute poverty 
covering over 100 developing countries. It complements traditional income-based 
poverty measures by capturing the severe deprivations that each person faces at the 
same time with respect to education, health and living standards.

2. DIMENSIONS AND INDICATORS

2.1 LIVING STANDARDS (Weight: 1/4)
----------------------------------
• Cooking fuel (1/28): Solid fuel use in enclosed spaces
• Water (1/28): Unclean source or >30 min collection time
• Assets (1/28): ≤1 small asset and no car
• Housing (1/28): Inadequate flooring/walls
• Overcrowding (1/28): >3 persons per sleeping room
• Electricity (1/28): No electric power
• Toilet (1/28): No facilities or bucket/pan/public toilet

2.2 EDUCATION (Weight: 1/4)
--------------------------
• School attendance (1/12): Any child (4-15 years) not attending school
• School attainment (1/12): No member completed ≥9 years of schooling
• School lag (1/12): Any member 2+ years behind in school

2.3 HEALTH (Weight: 1/4)
-----------------------
• Mortality (1/8): Child (<5) or pregnant mother died
• Health insurance (1/8): Not covered by national insurance

2.4 WAGE EMPLOYMENT (Weight: 1/4)
---------------------------------
• Employment (1/4): No employed member (15+ years)

3. CALCULATION METHODOLOGY

3.1 Deprivation Score
For each indicator:
- If deprived: Score = Indicator Weight
- If not deprived: Score = 0

3.2 MPI Score Calculation
MPI = Sum of all weighted deprivation scores

3.3 Poverty Thresholds
• MPI ≥ 0.33: Multidimensionally poor
• 0.20 ≤ MPI < 0.33: Vulnerable to poverty
• MPI < 0.20: Not multidimensionally poor

4. INTERPRETATION

The MPI identifies who is poor by considering the range of deprivations 
they suffer. It measures the incidence (proportion of people who are poor) 
and the intensity (average proportion of indicators in which poor people are deprived).
...
1. Policy Design: Target resources to poorest households
2. Monitoring: Track progress on SDG 1 (No Poverty)
3. Evaluation: Assess impact of social programs
4. Comparison: Benchmark against regional/national averages

7. LIMITATIONS

• Data availability and quality
• Weight assignment subjectivity
• Does not capture all dimensions of poverty
• May not reflect intra-household inequalities
...
==================================================
Document generated by MPI Calculator Application
Version 1.0 | Last updated: 2024
==================================================
"""
        
        # FIXED: Download button with string data
        st.download_button(
            label="📥 Download MPI Methodology Guide",
            data=mpi_guide_content,
            file_name="mpi_methodology_guide.txt",
            mime="text/plain"
        )
