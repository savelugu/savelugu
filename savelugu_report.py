...
fig = px.bar(
    ...
    text="Poverty Rate (%)",
    orientation="h",
    color_discrete_sequence=["#636EFA", "#EF553B", "#00CC96"],  # blue, red, green
...
fig = px.bar(
    ...
    text="Poverty Rate (%)",
    orientation="h",
    color_discrete_sequence=["#636EFA", "#AB63FA", "#FFA15A", "#19D3F3"],
...
fig = px.bar(
    df,
    y="Sector of Employment",
    x="Poverty Rate (%)",
    color="Sector of Employment",
    text="Poverty Rate (%)",
    orientation="h",
