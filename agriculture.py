...
def app():
    ...
    data = [
        ["Population in Agriculture", "Female", "% (0-100)",
         18, 20, 21, 22, 25, 25, 23, 21, 25, 27],
        ["Population in Agriculture", "Male", "% (0-100)",
         62, 63, 63, 64, 62, 62, 62, 64, 61, 60],
        ["Population in Agriculture", "Total", "% (0-100)",
         80, 83, 84, 86, 87, 87, 85, 85, 86, 87],

        ["Number of Farmers", "Female", "Number",
         14986, 15037, 15268, 16102, 16946, 18216, 19476, 19930, 35572, 35850],
        ["Number of Farmers", "Male", "Number",
         49603, 51812, 52384, 52645, 53372, 54357, 54865, 52840, 50450, 50683],
        ["Number of Farmers", "Total", "Number",
         64589, 66849, 67652, 68747, 70318, 72573, 74341, 72770, 86022, 86533],

        ["Livestock Reared", "Goats", "Number",
         68975, 71653, 74689, 77052, 81228, 91371, 98499, 98871, 104130, 107320],
        ["Livestock Reared", "Cattle", "Number",
         2985, 30975, 33581, 36872, 39046, 41226, 42052, 43356, 46230, 48120],
        ["Livestock Reared", "Poultry", "Number",
         91986, 93985, 95894, 98987, 106695, 112391, 115785, 116425, 120322, 125654],

        ["CSA Adoption Rate", "Total", "% (0-100)",
         11, 13, 23, 35, 40, 43, 45, 51, 53, 55],
    ]
